import torch
import math
from domain_knowledge_analysis.math import gaussian_log_prob, sample_gaussian, kl_divergence
...
def test_log_prob_returns_one_value_per_batch_element():
    ...
    result = gaussian_log_prob(z, mean, log_variance)
...
def test_sample_returns_correct_shape():
    ...
    result = sample_gaussian(mean, log_variance)
...
def test_kl_divergence_returns_one_value_per_batch_element():
    ...
    result = kl_divergence(mean, log_variance)
